fromfrom pyglet.window import Window
...
class Renderer(Window):
    def __init__(self):
        super().__init__(1000, 670, "Merge Sort Visualization")
        self.batch = Batch()
        ...
        for e, i in enumerate(self.x):
            self.bars.append(Rectangle(50 + e * 15, 50, 10, i * 10, color=(173, 216, 230), batch=self.batch))
